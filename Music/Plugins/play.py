...
"""
    ...
    if await is_on_off(1):
        ...
        if int(chat_id) != int(LOG_ID):
            return await message.reply_text(
                f"Bot sedang dalam proses updetan. Mohon untuk di tunggu!"
            )
        return await message.reply_text(
    ...
    if a.status != "administrator":
        await message.reply_text(
            """
Jadikan saya admin dengan beberapa izin✅

♪ **Dapat mengelola obrolan suara** 
♪ **menghapus sampah yang dicari musik**
♪ **mengundang asisten untuk mengobrol**
♪ **Melindungi musik dari spam**
"""
        )
        return
...
"""
        ...
        if len(message.command) < 2:
            ...
            photo=thumb, 
            caption=("**Penggunaan:** /play [/play judul lagu] atau tautan youtube \n\njika ingin memutar musik Pilih yang dari bawah✅"),    
